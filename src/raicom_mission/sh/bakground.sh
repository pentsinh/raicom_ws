...
tmux send -t background.1 'sleep 4 && roslaunch raicom_mission multy_cam.launch' C-m
# tmux send -t background.2 'sleep 3 && stty -F /dev/ttyUSB0 -hupcl' C-m
tmux send -t background.2 'sleep 6 && roslaunch raicom_mission arduino_nano.launch' C-m
